			...
			<div class="site-nav-submenu" id="submenu-3">
				...
				<div class="site-nav-submenu__item">
					<a href="delivery" class="site-nav-submenu__inner">
						<img src="<?php echo get_template_directory_uri(); ?>/img/site-nav/img/delivery.png" alt="">
						<h3>Доставка</h3>
					</a>
				</div>
				<div class="site-nav-submenu__item">
				...
				<div class="site-nav-submenu__item">
					<a href="fillet" class="site-nav-submenu__inner">
						<img src="<?php echo get_template_directory_uri(); ?>/img/site-nav/img/fillet.png" alt="">
						<h3>Раскладка</h3>
					</a>
				</div>
				<div class="site-nav-submenu__item">
					<a href="installation" class="site-nav-submenu__inner">
						<img src="<?php echo get_template_directory_uri(); ?>/img/site-nav/img/installation.png" alt="">
						<h3>Монтаж</h3>
					</a>
				</div>
				<div class="site-nav-submenu__item">
					<a href="accessories" class="site-nav-submenu__inner">
						<img src="<?php echo get_template_directory_uri(); ?>/img/site-nav/img/accessories.png" alt="">
						<h3>Комплектация</h3>
					</a>
				</div>					
			</div>							
